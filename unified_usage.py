...
def main():
    ...
    html_lines = [
        ...
        "        .header { font-size: min(1.8vw, 3.0vh); color: #aaaaaa; margin-bottom: 0; text-align: left; font-weight: 500; }",
        ...
        "        h2 { margin: 0; color: #ffffff; font-size: min(3.0vw, 4.5vh); font-weight: 400; }",
        "    </style>",
        "</head>",
        "<body>",
        "    <div class='title-bar'>",
