...
def main():
    ...
    html_lines = [
        ...
        "        table { width: 100%; border-collapse: collapse; font-size: min(2.8vw, 4.8vh); }",
        "        th, td { padding: min(0.7vw, 1.2vh) min(1.5vw, 2.5vh); text-align: left; border-bottom: 1px solid #333333; }",
        "        th { color: #4CAF50; font-weight: 600; text-transform: uppercase; font-size: min(2.4vw, 4.0vh); letter-spacing: 0.1vw; }",
        "        .header { font-size: min(2.2vw, 3.8vh); color: #aaaaaa; margin-bottom: 0; text-align: left; font-weight: 500; }",
        ...
        "        h2 { margin: 0; color: #ffffff; font-size: min(3.5vw, 5.5vh); font-weight: 400; }",
        "    </style>",
        "</head>",
        "<body>",
        "    <div class='title-bar'>",
